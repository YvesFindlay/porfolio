...
const Form = () => {
  ...
  const message =
    "Hi, we have a potential opportunity / with Company X / for a contract role / for a project. When are you free to discuss this further?";
  ...
  return (
    <form ref={formRef} onSubmit={submitFormHandler}>
      ...
      <button type="submit" value="Send Messsage">
        Submit
      </button>
    </form>
  );
