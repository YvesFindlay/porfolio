        ...
        <section className="about">
            ...
            <div className="about__header">
                <h2 className="about__heading"> 
                   Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugit, saepe voluptatem veniam asperiores voluptate.
                </h2>
                <div className="about__img-container">
                    <img src="about-img2.jpg" data-img-speed="0.2" className="about__img img1" />
                </div>
                <div className="about__text-container">   
                    <p className="about__text"> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Earum nihil ullam molestiae quam, sequi minus repellendus tenetur commodi accusamus ipsa eligendi, autem facere illo vitae provident rem optio cumque nemo.</p> 
                    <p className="about__text"> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Earum nihil ullam molestiae quam, sequi minus repellendus tenetur commodi accusamus ipsa eligendi, autem facere illo vitae provident rem optio cumque nemo.</p> 
                </div>  
            </div>
        </section>
