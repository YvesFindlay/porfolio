        ...
        <section className="location">
            <div className="location__content">
                <div className="location__text">
                    ...
                    <p className="location__text-paragraph"><span><ProfileIcon /></span>Yves Findlay, Web Developer</p>
                    <p className="location__text-paragraph"><span><MapIcon /></span>Kent, United Kingdom</p>
                    <a className="email-link" href="mailto:yves.findlay@gmail.com"><p className="location__text-paragraph"><span><EmailIcon /></span>yves.findlay@gmail.com</p></a>
                </div>
                <div className="location__map-container">
                    ...
                    <MapContainer style={{height: '100%'}} center={[51.3887, 0.0745]} zoom={10} scrollWheelZoom={false}>
                        ...
                        <Marker position={[51.3887, 0.0745]}>
                            <Popup>Yves Findlay <br /> Web Dev in Kent.</Popup>
                        </Marker>
                    </MapContainer>
                    </div>
                </div>
